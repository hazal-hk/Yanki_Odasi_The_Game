...
public class StoryBuilder {
    ...
    public static Scene buildMainStory() {
        ...
        // =================================================================================
        // ADIM 1: SAHNELERİ OLUŞTUR (Instantiation)
        // =================================================================================
        ...
        // --- ACT 2: THE ANATOMY OF A GHOST (YENİ EKLENDİ) ---
        ...
        s3_Library.addChoice(new Choice(
            ...
            p -> p.updateStats(-10, 20)
        ));

        s3_Library.addChoice(new Choice(
            "[DEFENSIVE] \"Don't make a crime out of a nap.\"", 
            s4_Crossroads, 
            p -> p.updateStats(10, -15)
        ));
        ...
        // --- ACT 1 SONU -> ACT 2 BAŞLANGICI (YENİ BAĞLANTILAR) ---
        ...
        // --- ACT 2: FINCH'S OFFICE SEÇİMLERİ (FLAG SİSTEMİ) ---
        ...
        s6_FinchOffice.addChoice(new Choice(
            ...
            p -> {
                System.out.println("FINCH: \"A convenient cage. If you're sick, you're not responsible.\"");
                p.updateStats(10, -15);
        ...
        s6_FinchOffice.addChoice(new Choice(
            ...
            p -> p.getConscience() >= 30, "Requires Conscience >= 30",
            p -> {
                System.out.println("FINCH: \"Honesty. The rarest material in architecture.\"");
        ...
        s6_FinchOffice.addChoice(new Choice(
            ...
            p -> p.getSanity() < 40, "Requires Low Sanity (<40)",
            p -> {
                System.out.println("FINCH: \"Touché. Two architects of ghosts.\"");
                p.updateStats(5, -10);
        ...
        s7_PhantomCall.addChoice(new Choice(
            ...
            p -> {
                System.out.println(">> The breathing pauses. A moment of peace.");
                p.updateStats(0, 5);
            }
        ));
        ...
        s7_PhantomCall.addChoice(new Choice(
            ...
            p -> {
                System.out.println(">> NARRATOR: Good. Don't let them scare you.");
                p.updateStats(0, -10);
            }
        ));
